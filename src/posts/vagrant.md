...
description: A curated list of awesome Vagrant resources, plugins, tutorials and other nice things.
tags: ['devops', 'automation', 'docker', 'kubernetes', 'ci-cd']
---

# Awesome Vagrant
[![Awesome](https://cdn.rawgit.com/sindresorhus/branch=master)](https://travis-ci.org/iJackUA/awesome-vagrant)
...
* [PuPHPet](https://puphpet.com/) - a simple GUI to set up virtual machines for PHP Web development.
