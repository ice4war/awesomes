...
description: A community curated list of awesome projects related to the Cosmos ecosystem
...
**Contributing:**
Please read the [Contributing guide](./CONTRIBUTING.md.html). Thank you to all our [contributors](https://github.com/cosmos/awesome/graphs/contributors).
...
A list of wallets supporting Cosmos chains is .
