---
title: "D"
description: "Awesome D [![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)"
...
_Official website URLs for D._
...
_The people that made D the language it is._
...
- [Andrei Alexandrescu, PhD](http://erdani.org/) - C++ guru. Author of _The D Programming Language_ and _Modern C++ Design_. With Walter Bright, Andrei co-designed many important features of D and authored a large part of D's standard library. Andrei works as a trainer in advanced C++ programming and algorithms and is now actively evangelizing D in the organization.
...
_Organizations that contribute to D projects._
...
_D related books._ You can find another list of books on the [Books](https://wiki.dlang.org/Books) D wiki page.

- [TDPL](https://www.amazon.com/The-Programming-Language-Andrei-Alexandrescu/dp/0321635361/) - _The D Programming Language_ by Andrei Alexandrescu.
...
_Official compilers for the D language._
...
_These compilers may differ from or be incompatible with the official set of tools._
...
_Tools for more productive D development._
...
_Manage projects and compile software from source code._
...
_Integrated Development Environment._
...
- [code-d](https://marketplace.visualstudio.com/items?itemName=webfreak.code-d) \[[open-vsx](https://open-vsx.org/extension/webfreak/code-d)\] - Visual Studio Code extension using serve-d
...
_Data structures and container libraries._
...
_General-purpose utility libraries._
...
_Clients and bindings to C clients for relational and nosql databases._
...
_Note_: You can also find a list of GUI libs on [wiki.dlang.org](https://wiki.dlang.org/Libraries_and_Frameworks#GUI_Libraries), but not all of the libraries are actively maintained now.
...
_Bindings to game development related libraries in C, C++, and other languages._
...
_D libraries for game development._
...
_Libraries for 2D-related projects._
...
_Parsing configuration files._
...
_Old or archived projects saved for reference._
