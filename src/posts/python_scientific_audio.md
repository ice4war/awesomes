---
title: Awesome Python Scientific Audio
description: The aim of this repository is to create a comprehensive, curated list of python softwaretools related and used for scientific research in audiomusic applications.
