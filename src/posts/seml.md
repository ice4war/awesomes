...
description: Software Engineering for Machine Learning are techniques and guidelines for building ML applications.
tags:
  - machine-learning
...
# Awesome Software Engineering for Machine Learning [![Awesome](https://style=flat-square)](https://github.com/SE-ML/awesome-seml/blob/master/contributing.md)
...
Contributions welcomed! Read the [contribution guidelines](contributing.md.html) first
