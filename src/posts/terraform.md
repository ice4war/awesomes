...
description: A curated list of resources on HashiCorps Terraform.
...
- [tfsec](https://github.com/aquasecurity/tfsec) - Terraform static analysis tool that supports terraform =0.12 & directly integrates with HCL parser for better results.
