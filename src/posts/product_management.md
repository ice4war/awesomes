...
description: A curated list of awesome resources for product and program managers.
tags:
  - product-management
  - program-management
  - product-owner
...
|----------------------------------------------------------------------------------------|-------------------------------|---------------------------------------------------------------------------|-------------|
|  | Den Delimarsky | https://theworkitem.com | Every week, Den Delimarsky sits down with folks from a range of industries, roles, and backgrounds to learn more about their career journey, lessons learned, and what it takes to map out your own very unique track. |
...
|  | Multiple | https://podcasts.apple.com/us/podcast/startup-podcast/id913805339 | The business origin story you never get to hear. |
...
|  | Multiple | https://www.thepitch.show/ | Where real entrepreneurs pitch to real investors—for real money. |
