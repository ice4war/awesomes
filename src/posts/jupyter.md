...
description: A curated list of awesome Jupyter projects, libraries and resources. Jupyter is an opensource web application that allows you to create and share documents that contain live code, equations, visualiza
