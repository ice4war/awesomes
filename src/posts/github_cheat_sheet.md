...
description: "GitHub Cheat Sheet [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)"
tags: ["github", "git"]
---
...
_Read this in other languages: [English](README.md.html), [한국어](README.ko.md.html), [日本語](README.ja.md.html), [简体中文](README.zh-cn.md.html), [正體中文](README.zh-tw.md.html)._
...
![git log --all --graph --pretty=format:'%Cred%h%Creset -%C(auto)%d%Creset %s %Cgreen(%cr) %C(bold blue)%Creset' --abbrev-commit --date=relative](http://i.imgur.com/58eOtkW.png)
