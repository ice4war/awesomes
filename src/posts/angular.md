...
description: The Awesome list of the Angular framework, containing intriguing libraries in the Angular ecosystem for all developers.
tags:
  - angular
  - javascript
  - frontend
...
* [unhead](https://www.npmjs.com/package/@unhead/angular) - Full-stack `` management for Angular applications.
...
* [ngx-advanced-toast](https://github.com/Hamed-kshiem/ngx-advanced-toast) - Advanced Angular toast notifications built on the native `` element — signals-first, zero RxJS, CSS-only animations, fully accessible.
