...
description: This is an awesome list of TensorFlow Lite models with sample apps, helpful tools and learning resources
tags: ['artificial-intelligence', 'machine-learning', 'deep-learning', 'ai', 'neural-networks']
---
...
# Awesome TensorFlow Lite [![Awesome](https://style=flat-square)](http://makeapullrequest.com) [![Twitter](https://img.shields.io/badge/Twitter-%40margaretmz-blue)](https://twitter.com/margaretmz)
...
Please submit a PR if you would like to contribute and follow the guidelines [here](CONTRIBUTING.md.html).
