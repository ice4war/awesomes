...
- [Insomnia](https://insomnia.rest) - Tests APIs with GraphQL support. ![Open-Source Software]
...
- [Ungoogled Chromium](https://github.com/ungoogled-software/ungoogled-chromium) - Removes Google integration and tracking. ![Open-Source Software]
...
- [btop4win](https://github.com/aristocratos/btop4win) - Windows port of the famous btop resource monitor. ![Open-Source Software]
- [Chocolatey](https://chocolatey.org/) - Package manager for Windows.
- [gallery-dl](https://github.com/mikf/gallery-dl) - Command-line program to download image galleries and collections from several image hosting sites. ![Open-Source Software]
...
- [Scoop](https://github.com/lukesampson/scoop) - Command-line installer for Windows. ![Open-Source Software]
...
- [yt-dlp](https://github.com/yt-dlp/yt-dlp) - A feature-rich command-line audio/video downloader. ![Open-Source Software]
...
- [OpenShell](https://github.com/Open-Shell/Open-Shell-Menu) - Restores traditional Start Menu interface. ![Open-Source Software]
...
- [TranslucentTB](https://github.com/TranslucentTB/TranslucentTB) - Makes taskbar transparent. ![Open-Source Software]
...
- [YASB](https://github.com/amnweb/yasb) - Creates customizable status bars. ![Open-Source Software]
...
- [DB Browser for SQLite](https://sqlitebrowser.org/) - Visual tool for creating and editing SQLite database files. ![Open-Source Software]
...
- [Gale](https://github.com/Kesomannen/gale) - Modern and lightweight mod manager for Thunderstore. ![Open-Source Software]
...
- [Oculante](https://github.com/woelper/oculante) - Lightweight, fast and simple image viewer written in rust. ![Open-Source Software] ![star]
...
- [AutoHotkey](https://autohotkey.com/) - Automation scripting language for Windows. ![Open-Source Software]
...
- [Kaas](https://github.com/0xfrankz/Kaas) - Privacy-focused LLM client for multiple AI services. ![Open-Source Software]
...
- [STranslate](https://github.com/ZGGSONG/STranslate) - A ready-to-go translation ocr tool developed with WPF ![Open-Source Software]
...
- [mRemoteNG](https://mremoteng.org/) - Multi-protocol remote connections manager. ![Open-Source Software]

## Screen Capture

- [Fraps](https://www.fraps.com/) - DirectX/OpenGL game recording utility.
- [Greenshot](https://github.com/greenshot/greenshot) - Screenshot capture and editing tool. ![Open-Source Software]
...
- [neohtop](https://github.com/Abdenasser/neohtop) - Modern system monitor built with Svelte and Rust. ![Open-Source Software] ![star]
...
- [scrcpy](https://github.com/Genymobile/scrcpy) - Easily mirror and control your Android devices on computers via USB or WiFi. ![Open-Source Software]
...
- [Alacritty](https://github.com/jwilm/alacritty) - Cross-platform, GPU-accelerated terminal emulator. ![Open-Source Software]
...
- [Notepad2](https://www.flos-freeware.ch/notepad2.html) - Lightweight Notepad replacement with enhanced features. ![Open-Source Software]
- [Sublime Text](https://www.sublimetext.com/3) - Advanced text editor with extensive plugin ecosystem.
- [Text Forge](https://text-forge.github.io/docs) - Lighweight, hackable, and highly modular text & code editor. ![Open-Source Software]
...
- [GitLight](https://github.com/colinlienard/gitlight) - Open-source GitHub & GitLab notifications client. ![Open-Source Software]
