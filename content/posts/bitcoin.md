...
description: A curated list of bitcoin services and tools for software developers.
tags:
  - bitcoin
  - cryptocurrency
  - blockchain
...
* [``](https://github.com/bitjson/qr-code) – A no-framework, no-dependencies, customizable, animate-able, SVG-based `` web component.
