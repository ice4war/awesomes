...
description: A collection of tiny JS libraries to put your bundle on a diet.
tags:
  - javascript
  - libraries
  - lightweight
...
See [WIP.md](./WIP.md.html) for a list of small libraries I have found, but not yet analyzed deeply.

Suggestions welcome! Please check that the lib you're suggesting:

- Fits the [criteria.](#awesome-tiny-js)
- Is not already in [WIP.](./WIP.md.html) 
