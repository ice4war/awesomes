---
title: Awesome Tensorflow Js
description: TensorFlow.js is an open source software library to develop machine learning models in JavaScript, and use machine learning
...
More info on the [guidelines](CONTRIBUTING.md.html).
