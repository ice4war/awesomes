...
description: Looking to find a book an interesting book to read but dont know where to start You are in the right place
...
See [Contributing Guidelines](CONTRIBUTING.md.html) for details on how the books are curated.
