---
title: Critical-path CSS Tools
description: Tools to help prioritize above-the-fold CSS.
tags:
  - css
  - performance
  - optimization
...
* Determine the above-the-fold styles for a page and write them between `` tags in the head.
...
* [inline-styles](https://github.com/maxogden/inline-styles) - by Max Ogden, replaces `` tags with inline `` tags + inlines CSS url() calls with data URIs
* [gulp-inline-source](https://github.com/fmal/gulp-inline-source) - by Filip Malinowski, replaces `` tags with inline `` tags, and replaces `` tags with their inline content
