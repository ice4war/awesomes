 ...
 * [mediaelement](https://github.com/johndyer/mediaelement) - HTML5  or  player with Flash and Silverlight shims that mimics the HTML5 MediaElement API, enabling a consistent UI in all browsers. 
 ...
 * [Lettering.js](https://github.com/davatron5000/Lettering.js) - A lightweight, easy to use JavaScript `` injector for radical Web Typography.
