...
description: A collection of awesome things regarding the .NET Core ecosystem, including frameworks, libraries, tools, and resources.
tags:
  - CSharp
  - dotnet
  - netcore
...
* [Linq_Faster](https://github.com/jackmott/LinqFaster) - Linq-like extension functions for Arrays, Span, and List that are faster and allocate less.
