---
title: "Eslint"
description: "Awesome ESLint [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)"
...
If you want to contribute, please read the [contribution guidelines](contributing.md.html).
...
- [mutate](https://github.com/gchumillas/eslint-plugin-mutate) - Prevent accidental parameter mutations by enforcing explicit `mut` prefix (JavaScript) or `Mut` type annotation (TypeScript).
