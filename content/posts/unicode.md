...
description: A curated list of delightful Unicode tidbits, packages and resources.
...
*Key Unicode terminology is defined in the [glossary](GLOSSARY.md.html).*
...
See the *Awesome Unicode* [contribution guide](CONTRIBUTING.md.html) for details on how to contribute.

# Code of Conduct

See the [Code of Conduct](CODE-OF-CONDUCT.md.html) for details. Basically it comes down to:
